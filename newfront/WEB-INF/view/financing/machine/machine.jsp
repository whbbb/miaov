...
<div class="pow">
    <div class="pow-left">
    <div class="pow-bam">
        <p class="p-b-content">优车宝是优金客推出的，专门以借款人自有车辆为抵押物，联合第三方担保公司做担保的理财产品。</p>
    </div>
     <ul class="pow-list">
     	<s:if test="pzSysUserInfoOrderViewList03.size() > 0">
        	<s:iterator value="pzSysUserInfoOrderViewList03">
            <li class="machinebg" request-url="../../../financing/financial-details.do?orderType=01&userOrderCode=<s:property value='userOrderCode'/>" >
                <!--left--left-->
                <div class="p-l-left">
                    <div class="p-l-top">
        ...
        <s:include value="/WEB-INF/view/common/page.jsp">
        	...
        	<s:param name="refreshDom" value="'J_machine'"></s:param>
        	<s:param name="pageNum" value="pageNo"></s:param>
        	<s:param name="orderType" value="'03'"></s:param>
