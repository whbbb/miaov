...
<div class="pow">
    <div class="pow-left">
    <div class="pow-bam">
        <p class="p-b-content">优选计划是优金客为满足不同需求的会员，所提供的理财服务。 理财人可根据各自投资偏好及风险承受能力，自由构建投资组合。</p>
    </div>
     <ul class="pow-list">
     	<s:if test="pzSysUserInfoOrderViewList01.size() > 0">
        	<s:iterator value="pzSysUserInfoOrderViewList01">
            <li class="arrangedbg"   request-url="../../../financing/financial-details.do?orderType=01&userOrderCode=<s:property value='userOrderCode'/>" >
                <!--left--left-->
                <div class="p-l-left">
                    <div class="p-l-top">
        ...
        <s:include value="/WEB-INF/view/common/page.jsp">
        	...
        	<s:param name="refreshDom" value="'J_arranged'"></s:param>
        	<s:param name="pageNum" value="pageNo"></s:param>
        	<s:param name="orderType" value="'01'"></s:param>
