...
<script type="text/javascript" src="../../../js/financing/antrum/antrum.js"></script>
...
<div class="pow">
    <div class="pow-left">
    <div class="pow-bam">
        <p class="p-b-content">优房宝是优金客推出的，专门以借款人自有房产为抵押物，联合第三方担保公司做担保的理财产。</p>
    </div>
        <ul class="pow-list">
        	<s:if test="pzSysUserInfoOrderViewList02.size() > 0">
	        	<s:iterator value="pzSysUserInfoOrderViewList02">
	            <li class="antrumbg" request-url="../../../financing/financial-details.do?orderType=01&userOrderCode=<s:property value='userOrderCode'/>">
	                <!--left--left-->
	                <div class="p-l-left">
	                    <div class="p-l-top">
        ...
        <s:include value="/WEB-INF/view/common/page.jsp">
        	...
        	<s:param name="refreshDom" value="'J_antrum'"></s:param>
        	<s:param name="pageNum" value="pageNo"></s:param>
        	<s:param name="orderType" value="'02'"></s:param>
