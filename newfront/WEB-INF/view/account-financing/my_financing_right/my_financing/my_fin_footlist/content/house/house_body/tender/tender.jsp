...
<script type="text/javascript" src="../../../js/account-financing/my_financing_right/my_financing/my_fin_footlist/content/house/house_body/tender/tender.js" ></script>
...
<s:if test="allCountOutput != null ">
	...
	<!--
		$().ready(function(){
			...
			li.eq(1).addClass("green-current").html("投标中（<s:property value='allCountOutput.bidCount' default='0'/>）").append('<div class="listnav-current"></div>');
...
<div class="tender">
	<ul class="tender-tit">
	    <li class="tender-one">借款标题</li>
	    <li class="tender-two">年利率</li>
	    <li class="tender-three">借款期限</li>
	    <li class="tender-three">借款金额</li>
	    <li class="tender-three">投标金额</li>
	    <li class="tender-three">投标日期</li>
	    <li class="tender-four">还款方式</li>
	</ul>
	<s:if test="biddingListOutput.pzSysOrderUserOrderViewList.size() > 0">
		<table class="tendertab">
			<s:iterator value="biddingListOutput.pzSysOrderUserOrderViewList">
			    <tr class="tab-tr">
			                ...
			                <div class="details-list">
			                    <table class="list-tab p-l-bottom">
			                    	<s:iterator value="bfmap[bidCode]">   
				                        <tr class="plb-time">
				                        	<input class="p-timer" type="hidden" value="<s:property value='orderReleaseEndTime' default='000:00:00'/>"/>
				                            ...
				                            <td class="p-time"><s:property value='orderReleaseEndTime' default='000:00:00'/></td>
				                        </tr>
			                        </s:iterator>
			                    </table>
			                </div>
			        ...
			        <td class="tender-two"><s:property value="orderApr" default="0"/>%</td>
			        <td class="tender-three"><s:property value="orderCycle" default="0"/>个月</td>
			        <td class="tender-three"><s:property value="orderMoney" default="0"/>元</td>
			        <td class="tender-three"><s:property value="bidMoney" default="0"/>元</td>
			        <td class="tender-three"><s:property value="bidTime.substring(0,11)"/></td>
			        <td class="tender-four">
			            <!-- id = mode 控制显示-->
			            <s:if test="orderRefund=='01'"><div class="tender-four tender-deng mode" title="等额本息，每月还款"></div></s:if>
			        	<s:elseif test="orderRefund=='04'"><div class="tender-four tender-yue mode" title="按月付息，到期还本"></div></s:elseif>
			        	<s:elseif test="orderRefund=='03'"><div class="tender-four tender-ben mode" title="到期后，本息一次性还款"></div></s:elseif>
			        </td>
...
<s:include value="/WEB-INF/view/common/page.jsp">
	...
	<s:param name="refreshDom" value="'J_tender'"></s:param>
