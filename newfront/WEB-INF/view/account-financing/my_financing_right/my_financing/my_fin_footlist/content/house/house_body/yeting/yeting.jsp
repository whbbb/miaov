...
<script type="text/javascript" src="../../../js/account-financing/my_financing_right/my_financing/my_fin_footlist/content/house/house_body/yeting/yeting.js" ></script>
<s:if test="allCountOutput != null ">
	<script type="text/javascript">
	<!--
		$().ready(function(){
			var li = $(".inv-list-nav li");
			li.eq(0).addClass("green-current").html("还款中（<s:property value='allCountOutput.refundCount' default='0'/>）").append('<div class="listnav-current"></div>');
...
<div class="yeting">
    <ul class="yet-tit">
        <li class="yet-one">借款标题</li>
        <li class="yet-two">年利率</li>
        <li class="yet-three">借款期限</li>
        <li class="yet-four">借款金额</li>
        <li class="yet-four">投标金额</li>
        <li class="yet-four">应收总额</li>
        <li class="yet-four">已收总额</li>
        <li class="yet-five">还款方式</li>
    </ul>
    <s:if test="biddingListOutput.pzSysOrderUserOrderViewList.size() > 0">
    	<table class="yetingtab">
			<s:iterator value="biddingListOutput.pzSysOrderUserOrderViewList">
		        <tr class="tab-tr">
		            ...
		            <td class="yet-two"><s:property value="orderApr" default="0"/>%</td>
		            <td class="yet-three"><s:property value="orderCycle" default="0"/>个月</td>
		            <td class="yet-four"><s:property value="orderMoney" default="0"/>元</td>
		            <td class="yet-four"><s:property value="bidMoney" default="0"/>元</td>
		            <td class="yet-four"><s:property value="orderMonthRefund" default="0"/>元</td>
		            <td class="yet-four"><s:property value="serviceFee" default="0"/>元</td>
		            <td class="yet-five ">
		                <!-- id = mode 控制显示-->
		                <s:if test="orderRefund=='01'"><div class="yet-five yet-deng mode" title="等额本息，每月还款"></div></s:if>
			        	<s:elseif test="orderRefund=='04'"><div class="yet-five yet-yue mode" title="按月付息，到期还本"></div></s:elseif>
			        	<s:elseif test="orderRefund=='03'"><div class="yet-five yet-ben mode" title="到期后，本息一次性还款"></div></s:elseif>
		            </td>
		        </tr>
		    </s:iterator>
    	</table>
...
<s:include value="/WEB-INF/view/common/page.jsp">
	...
	<s:param name="refreshDom" value="'J_yeting'"></s:param>
