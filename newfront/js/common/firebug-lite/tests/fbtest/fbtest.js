...
(function(window) {
    ...
    runner.prototype.runPage = function() {
        ...
        addEvent(header, "click", function(event)
        {
            ...
            // run button
            var testIndex = target.getAttribute("data-fbtest-run-product");
            if (testIndex)
            {
            ...
            var testIndex = target.getAttribute("data-fbtest-view-product");
            if (testIndex)
            {
    ...
    runner.prototype.pageProgress = function(frame, failures, total, testName, isDone) {
        ...
        for(var i=0, l=tests.length; i<l; i++)
        {
            ...
            if (test.frame === frame) {
                ...
                header.innerHTML = "<a title='Run the Test Case again' data-fbtest-run-product='"+i+"' href='javascript:void(0)'>run</a> " +
                        "<a title='Open the Test Case in another tab' target='about:blank' href='"+test.page+"'>link</a> "+
                        "<a title='View Test Case in fullscreen mode' data-fbtest-view-product='"+i+"' href='javascript:void(0)'>view</a>" +
