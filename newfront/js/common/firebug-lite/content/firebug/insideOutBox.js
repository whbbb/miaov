...
FBL.InsideOutBoxView = {
     ...
     *
     * If both product and previousSibling are passed, the implementation
...
FBL.InsideOutBox = function(view, box)
{
    ...
    // TODO: xxxpedro event
    //3dbox_1.1.addEventListener("mousedown", this.onMouseDown, false);
};
...
InsideOutBox.prototype =
{
    destroy: function()
    {
        ...
        // TODO: xxxpedro event
        //this.3dbox_1.1.removeEventListener("mousedown", this.onMouseDown, false);
    },
