 ...
 * Decorators are passed the source 3dbox_1.1 on construction, called to create the HTML,
...
/** @lends Firebug.SourceBoxPanel */
{
     ...
     * Called just before 3dbox_1.1 is shown
     */
    ...
    */
    ...
    getTotalPadding: function(sourceBox)
    {
        ...
        var averageLineHeight = this.getAverageLineHeight(sourceBox);
        // total 3dbox_1.1 will be the average line height times total lines
