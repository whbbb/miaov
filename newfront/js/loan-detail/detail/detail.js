    ...
    var _detail = {
        ...
        _change_img: function( type ){
            ...
            if( frame_obj ){
                ...
                if( img_obj ){
                    var img_path = "../../../img/loan-detail/detail/img/" + para.index + ".jpg";
            ...
            $.delay_load(
                ...
                function(){
                    ...
                    if( frame_obj ){
                        ...
                        if( img_obj ){
                            var img_path = "../../../img/loan-detail/detail/img/" + index + ".jpg";
                            img_obj.attr( "src", img_path );
